        ...
        <table className="border-collapse border border-gray-400">
            <thead className="bg-gray-200 border border-gray-400">
                <tr className="text-center">
                    <th className="border border-gray-400 p-4 ml-2" onClick={()=> {handleSort("sno")}}>S.no {}</th>
                    <th className="border border-gray-400 p-4" onClick={()=> {handleSort("name")}}>Name {}</th>
                    <th className="border border-gray-400 p-4" onClick={()=> {handleSort("department")}}>Department {}</th>
                    <th className="border border-gray-400 p-4" onClick={()=> {handleSort("DOJ")}}>Date of Joining {}</th>
                    <th className="border border-gray-400 p-4" onClick={()=> {handleSort("experience")}}>Experience {}</th>
                    <th className="border border-gray-400 p-4" onClick={()=> {handleSort("rating")}}>Rating {}</th>
                    <th className="border border-gray-400 p-4" onClick={()=> {handleSort("salary")}}>Salary {}</th>
                </tr>
            </thead>
            <tbody>
                    {
                        data.map((item)=> {
                            return (
                                <tr key={item.employee_id} className={item.employee_id % 2 === 0 ? 'bg-amber-50' : 'bg-green-50'}>
                                    <td className="border border-gray-400 p-4 text-center">{item.employee_id}</td>
                                    <td className="border border-gray-400 p-4 text-center">{item.first_name}</td>
                                    <td className="border border-gray-400 p-4 text-center">{item.department}</td>
                                    <td className="border border-gray-400 p-4 text-center">{item.hire_date}</td>
                                    <td className="border border-gray-400 p-4 text-center">{item.years_of_experience}</td>
                                    <td className="border border-gray-400 p-4 text-center">{item.performance_rating}</td>
                                    <td className="border border-gray-400 p-4 text-center">{item.salary}</td>
                                </tr>
